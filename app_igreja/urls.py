...
from .views.admin_area.views_whatsapp import whatsapp_enviar_mensagem, whatsapp_list, whatsapp_detail, whatsapp_debug
...
from .views.area_publica.views_celebracoes import minhas_celebracaoes_publico
from .views.area_publica.views_doacoes import doacoes_publico
from .views.area_publica.views_whatsapp_api import whatsapp_webhook, whatsapp_test_webhook, whatsapp_cadastro_dizimista
from .views.area_publica.views_mural import mural_publico
from .views.area_publica.views_colaboradores_publico import cadastro_colaborador_publico, api_buscar_cep, api_excluir_colaborador 
...
urlpatterns = [
    ...
    # URLs para Cadastro Público de Colaboradores (usando telefone como chave)
